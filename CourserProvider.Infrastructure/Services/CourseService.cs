...
using CourserProvider.Infrastructure.Factories;
using CourserProvider.Infrastructure.Models;
using Microsoft.EntityFrameworkCore;

namespace CourserProvider.Infrastructure.Services;
...
public class CourseService(IDbContextFactory<DataContext> contextFactory) : ICourseService
{
    ...
    {
        await using var context = _contextFactory.CreateDbContext();
        var courseEntity = await context.Courses.FirstOrDefaultAsync ( context => context.Id == id );
